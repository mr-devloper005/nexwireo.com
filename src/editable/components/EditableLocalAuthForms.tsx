...
const inputClass = 'h-[3.25rem] rounded-full border border-black/10 bg-white px-4 text-base font-bold text-black outline-none transition placeholder:text-black/35 focus:border-[var(--slot4-accent)]'
const buttonClass = 'inline-flex h-[3.25rem] items-center justify-center rounded-full bg-[var(--slot4-accent)] px-6 text-xs font-black uppercase tracking-[0.2em] text-[#071406] transition hover:bg-[#071406] hover:text-white disabled:opacity-60'
