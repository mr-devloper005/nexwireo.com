    ...
    <section className="bg-[#f6faf3]">
      <header className="border-b border-black/10 bg-white">
        <div className="mx-auto max-w-[1180px] px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
          ...
          <h1 className="mt-6 max-w-6xl text-5xl font-black leading-tight tracking-normal sm:text-6xl lg:text-[5rem]">{post.title}</h1>
        </div>
      </header>

      {images[0] ? (
        <figure className="mx-auto max-w-[1180px] border-x border-b border-black/10 bg-white">
      ...
      <div className="mx-auto grid max-w-[1180px] gap-12 px-4 py-12 sm:px-6 lg:grid-cols-[minmax(0,760px)_300px] lg:px-8 lg:py-16">
        <article className="min-w-0 border-t-4 border-[var(--slot4-accent)] bg-white p-6 shadow-[0_12px_40px_rgba(7,20,6,.06)] sm:p-8">
...
function RelatedCard({ task, post }: { task: TaskKey; post: SitePost }) {
  ...
  return (
    <Link href={buildPostUrl(task, post.slug)} className="group flex gap-3 border-t border-black/15 py-3 transition hover:text-[#4b9d24]">
